...
public class ClickHouseDatabaseSync extends DatabaseSyncBase {
    ...
    public List<OceanBaseTable> getObTables(){
        ...
        List<Tuple2<String, String>> tableNames = getTableNames(source.getDatabase(),source.getTables());
    ...
    public List<PartitionInfo> getPartitions(
        ...
        try {
            return ClickHouseJdbcUtils.obtainPartitionInfo(getConnection(), databaseName, tableName);
        } catch (SQLException e) {
    ...
    public List<Tuple2<String, String>> getTableNames(String databases,String tables) {
        ...
        try {
             return ClickHouseJdbcUtils.executeDoubleColumnStatement(getConnection(), sql,databases,tables);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
